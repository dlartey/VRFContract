...
import lotteryContract from '../../blockchain/keccak.js'
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Keccak Lottery dApp</title>
        <meta name="description" content="A simple smart contract to benchmark how long it takes Keccak256 to produce randomness" />
